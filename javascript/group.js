    ...
    .then(function (json) {
      if (json["status_code"] === 200) {
        ...
        groups.forEach(element => {
          ...
          document.querySelector(".search-result").innerHTML += `<div class="group-setting">
    ...
    .then(function (json) {
      if (json.status_code == 200) {
        ...
        myGroups.forEach(element => {
          document.getElementById("myGroups").innerHTML += `<div id = '${element.groupID}' onclick = activeGroup(${element.groupID}) class="group-setting">
