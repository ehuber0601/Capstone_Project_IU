    ...
    if ($result = mysqli_query($conn, $sql)) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $$userID = rand(pow(10, $digits - 1), pow(10, $digits) - 1);
             $sql_insert = "INSERT INTO Profile (`ProfileID`, `firstName`, `lastName`, `userName`, `password`, `followers` , `bio` ) VALUES ( '425', '$form_data[1]', '$form_data[2]' , '$form_data[0]' , '$form_data[3]' , '' , '')";
